...
export const CourseAttachments = () => {
  const [attachments, setAttachments] = React.useState<AttachmentDto[] | null>(
    null
  );
  ...
  const emptyRows =
    page > 0
      ? Math.max(0, (1 + page) * rowsPerPage - (attachments?.length ?? 0))
      : 0;
          ...
          <Table sx={{ width: "100%" }} size="small" aria-label="simple table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align="left">Pobierz</TableCell>
              </TableRow>
            </TableHead>
              ...
              {visibleRows?.map((row) => (
                <TableRow
                  ...
                  <TableCell align="left">
                    {dateToLocale(row.uploadTime)}
                  </TableCell>
                  <RowExpand value={row.description}/>
                  <TableCell align="left">
                    {row.tags.map((tag) => (
                      <span>{tag},</span>
                    ))}
                  ...
                  <TableCell align="left">
                    <FileDownload cid={id} aid={row._id} />
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
